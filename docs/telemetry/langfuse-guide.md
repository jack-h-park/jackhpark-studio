...
> For operational verification, start with the canonical playbook [`docs/telemetry/operations/telemetry-operational-verification-local.md`](operations/telemetry-operational-verification-local.md), then use the [Telemetry Operational Verification Local Supplement](../operations/telemetry-operational-verification-local.md) for exact local fields and ownership hints.
